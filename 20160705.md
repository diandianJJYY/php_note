...
```
当函数未定义参数时，若调用函数时想传入参数可用[`func_get_args()`](http://php.net/manual/zh/function.func-get-args.php)实现；

#### 2.2 调用函数时传入参数的个数与原函数定义的不符：
